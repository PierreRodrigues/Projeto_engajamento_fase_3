<!--# DnqQFF4NjqBWqVFs0VP28VrPSHmqJsrF2sVHs3Rd-->
...
<script language="JavaScript">var defLang = 'pt_BR'</script>
<!--Ultrapar Participacoes-I-->
<style type="text/css">
body {
...
if (document.getElementById("pt_BR")) document.getElementById("btn_pt_BR").style.color="#009dd0";if (document.getElementById("btn_"+id)) {document.getElementById("btn_"+id).style.color="#77797c"; }
if (document.getElementById(id)) {
if (document.getElementById("en_US")) document.getElementById("en_US").style.display="none";
if (document.getElementById("pt_BR")) document.getElementById("pt_BR").style.display="none";document.getElementById(id).style.display="";
}
}
...
<a id='btn_pt_BR' onclick="changeLanguage('pt_BR')">Português</a></td>
</tr>
</table>
...
Ultrapar Participacoes-I</td></tr>
</tbody></table></div>
...
<tr><td class="eu_co">
<b><script>
    function VerDados(url,largura,altura)
    {
      window.open(url,'portfolio','width='+largura+',height='+altura+',scrollbars=yes, resizable=no, channelmode=2,menubar=no,toolbar=yes,left=100, top=100' );
    }
  </script>
<style> .eu_co.st {display: none;} .s_img {display:none;} </style>
Controle de Conteúdo<br><br>

Prezado (a), colaborador (a),<br><br>

O acesso a página foi bloqueado pelo sistema de controle de conteúdo, conforme diretrizes da nossa Política de Segurança da Informação.<br><br>

Na necessidade de uma análise sobre o bloqueio, solicitamos a abertura de um chamado em nosso portal de serviços, clicando no link abaixo: <br><br>
<a href="#" onClick="VerDados('https://portaldeservicos.ipiranga.com.br/ipiranga?sysparm_stack=no', '800','500');"> Portal de Serviços</a><br><br></b>
</td></tr>
<tr><td class="eu_co rsn">
Not allowed to access this file type
</td></tr>
<tr><td class="eu_co">
You tried to visit:<div class="eu_l"><a href="https://raw.githubusercontent.com/nandotrystan/ada_globo/refs/heads/main/entidades/tempCodeRunnerFile.py">https://raw.githubusercontent.com/nandotrystan/ada_globo/refs/heads/main/entidades/tempCod...</a></div>
</td></tr><tr>
<td class="hr"><hr></td>
</tr>
<tr><td class="eu_co ln">
<a href="https://extranet.ultra.com.br/si/cartilha_port.html">
See our internet use policy.
</a>
</td></tr>
<tr><td class="eu_co fo">
Need help? Contact our support team at <a href="mailto:seguranca.informacao@ipiranga.ipiranga">seguranca.informacao@ipiranga.ipiranga</a>
</td></tr>
...
<!--/locale en_US-->
<!--locale pt_BR-->
<table id='pt_BR' style="display:none" width="100%" border="0" cellspacing="0" cellpadding="0">
<tbody><tr><td class="eu_h">
<i class="a_i"></i>
Desculpe, você não tem permissão para visitar este site.
</td></tr>
<tr><td class="hr"><hr></td></tr>
<tr><td class="eu_co">
<b><script>
...
<tr><td class="eu_co rsn">
Não é permitido acessar este tipo de arquivo
</td></tr>
<tr><td class="eu_co">
Você tentou visitar:
<div class="eu_l"><a href="https://raw.githubusercontent.com/nandotrystan/ada_globo/refs/heads/main/entidades/tempCodeRunnerFile.py">https://raw.githubusercontent.com/nandotrystan/ada_globo/refs/heads/main/entidades/tempCod...</a></div>
</td></tr><tr>
<td class="hr"><hr></td>
</tr>
<tr><td class="eu_co ln">
<a href="https://extranet.ultra.com.br/si/cartilha_port.html">
Leia a nossa política de uso da internet.
</a>
</td></tr>
<tr><td class="eu_co fo">
Precisa de ajuda? Entre em contato com a nossa equipe de suporte em <a href="mailto:seguranca.informacao@ipiranga.ipiranga">seguranca.informacao@ipiranga.ipiranga</a>
</td></tr>
<tr><td class="eu_co st red">
<span class="s_img"></span>
Sua empresa escolheu a Zscaler para proteger você de ameaças na internet.
</td></tr>
</tbody></table>
<!--/locale pt_BR-->
</td></tr>
...
<!-- 1210249 1 39 0 1749855907 132 https://raw.githubusercontent.com/nandotrystan/ada_globo/refs/heads/main/entidades/tempCodeRunnerFile.py -->